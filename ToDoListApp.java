...
public class ToDoListApp {
    ...
    private static void createAndShowGUI() {
        ...
        JButton addButton = createStyledButton("Add Task", new Color(190,18,145));
        addButton.addActionListener(e -> addTask());
        topPanel.add(addButton);

        JButton editButton = createStyledButton("Edit Task", new Color(150, 112, 216));
        ...
        JButton clearButton = createStyledButton("Clear All Tasks", new Color(180, 34, 34));
